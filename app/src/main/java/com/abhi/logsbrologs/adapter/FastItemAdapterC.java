 ...
 */
public class FastItemAdapterC<Item extends IItem> extends FastAdapter<Item> {
    private final ItemAdapterC<Item> mItemAdapter = new ItemAdapterC<>();

    /**
     * ctor
     */
    public FastItemAdapterC() {
     ...
     *
     * @return the ItemAdapter used inside this FastItemAdapterC
     */
    public ItemAdapterC<Item> getItemAdapter() {
        return mItemAdapter;
    }
     ...
     * @return this
     */
    public FastItemAdapterC<Item> withUseIdDistributor(boolean useIdDistributor) {
     ...
     * @return this
     */
    public FastItemAdapterC<Item> withFilterPredicate(IItemAdapter.Predicate<Item> filterPredicate) {
     ...
     */
    public FastItemAdapterC<Item> set(List<Item> items) {
     ...
     * @param items the new items to set
     */
    public FastItemAdapterC<Item> setNewList(List<Item> items) {
     ...
     */
    @SafeVarargs
    public final FastItemAdapterC<Item> add(Item... items) {
     ...
     * @param items the items to add
     */
    public FastItemAdapterC<Item> add(List<Item> items) {
        mItemAdapter.add(items);
        return this;
    }
     ...
     */
    @SafeVarargs
    public final FastItemAdapterC<Item> add(int position, Item... items) {
     ...
     * @param items    the items to add
     */
    public FastItemAdapterC<Item> add(int position, List<Item> items) {
        mItemAdapter.add(position, items);
        return this;
    }
     ...
     */
    public FastItemAdapterC<Item> set(int position, Item item) {
     ...
     */
    public FastItemAdapterC<Item> add(Item item) {
     ...
     * @param item     the item to add
     */
    public FastItemAdapterC<Item> add(int position, Item item) {
     ...
     * @return this
     */
    public FastItemAdapterC<Item> move(int fromPosition, int toPosition) {
     ...
     * @param position the global position
     */
    public FastItemAdapterC<Item> remove(int position) {
     ...
     */
    public FastItemAdapterC<Item> removeItemRange(int position, int itemCount) {
     ...
     */
    public FastItemAdapterC<Item> clear() {
        mItemAdapter.clear();
        return this;
    }
