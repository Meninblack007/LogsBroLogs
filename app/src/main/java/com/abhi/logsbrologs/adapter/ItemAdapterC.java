...
/**
 * Created by mikepenz on 27.12.15. Cloned for modifications by out386
...
public class ItemAdapterC<Item extends IItem> extends AbstractAdapter<Item> implements IItemAdapter<Item> {
     ...
     * @return this
     */
    ItemAdapterC withUseIdDistributor(boolean useIdDistributor) {
     ...
     * @return this
     */
    public ItemAdapterC<Item> withItemFilter(Filter itemFilter) {
     ...
     * @return this
     */
    ItemAdapterC<Item> withFilterPredicate(Predicate<Item> filterPredicate) {
     ...
     * @return this
     */
    public ItemAdapterC<Item> withItemFilterListener(ItemFilterListener listener) {
     ...
     * @return this
     */
    public ItemAdapterC<Item> withComparator(Comparator<Item> comparator) {
     ...
     * @return this
     */
    private ItemAdapterC<Item> withComparator(Comparator<Item> comparator, boolean sortNow) {
     ...
     */
    public ItemAdapterC<Item> set(List<Item> items) {
        return set(items, true);
    }

    private ItemAdapterC<Item> set(List<Item> items, boolean resetFilter) {
        if (mUseIdDistributor) {
            IdDistributor.checkIds(items);
        }

        //reset the filter
        if (resetFilter && getItemFilter() instanceof ItemAdapterC.ItemFilter && ((ItemFilter) getItemFilter()).getConstraint() != null) {
     ...
     */
    public ItemAdapterC<Item> setNewList(List<Item> items) {
        if (mUseIdDistributor) {
            IdDistributor.checkIds(items);
        }

        //reset the filter
        if (getItemFilter() instanceof ItemAdapterC.ItemFilter && ((ItemAdapterC.ItemFilter) getItemFilter()).getConstraint() != null) {
            ((ItemAdapterC.ItemFilter) getItemFilter()).performFiltering(null);
        }
     ...
     */
    @SafeVarargs
    public final ItemAdapterC<Item> add(Item... items) {
     ...
     * @param items the items to add
     */
    public ItemAdapterC<Item> add(List<Item> items) {
        if (mUseIdDistributor) {
            IdDistributor.checkIds(items);
        }
     ...
     */
    @SafeVarargs
    public final ItemAdapterC<Item> add(int position, Item... items) {
     ...
     * @param items    the items to add
     */
    public ItemAdapterC<Item> add(int position, List<Item> items) {
        if (mUseIdDistributor) {
            IdDistributor.checkIds(items);
        }
     ...
     */
    public ItemAdapterC<Item> set(int position, Item item) {
        if (mUseIdDistributor) {
     ...
     * @return this
     */
    ItemAdapterC<Item> move(int fromPosition, int toPosition) {
     ...
     * @param position the global position
     */
    public ItemAdapterC<Item> remove(int position) {
     ...
     */
    public ItemAdapterC<Item> removeRange(int position, int itemCount) {
     ...
     */
    public ItemAdapterC<Item> clear() {
    ...
    public class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                if (mFilterPredicate != null) {
                    if (results != null && results.values != null && mNewItem != null)
                        if (!mFilterPredicate.filter(mNewItem, constraint)) {
                            List<Item> tempList = ((List<Item>) results.values);
                            tempList.add(mNewItem);
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            ...
            if (results.values != null) {
                ItemAdapterC.this.set((List<Item>) results.values, false);
            }
        ...
        /**
         * helper method to get all selections from the ItemAdapterC's original item list
         *
         ...
         * helper method to get all selections from the ItemAdapterC's original item list
         *
         * @return a Set with the selected items out of all items in this ItemAdapterC (not the listed ones)
         */
        ...
        public ItemAdapterC<Item> add(List<Item> items) {
            if (mOriginalItems != null && items.size() > 0) {
                ...
                if (items.size() == 1)
                    mNewItem = items.get(0);
                publishResults(mConstraint, performFiltering(mConstraint));
                return ItemAdapterC.this;
            } else {
                return ItemAdapterC.this.add(items);
            }
        }
        ...
        public ItemAdapterC<Item> add(int position, List<Item> items) {
            if (mOriginalItems != null && items.size() > 0) {
                ...
                return ItemAdapterC.this.add(position, items);
            }
        }
        ...
        public ItemAdapterC<Item> set(int position, Item item) {
            if (mOriginalItems != null) {
                ...
                return ItemAdapterC.this.set(position, item);
            }
        }
         ...
         * @return this
         */
        public ItemAdapterC<Item> move(int fromPosition, int toPosition) {
            if (mOriginalItems != null) {
                int preItemCount = getFastAdapter().getPreItemCount(fromPosition);
                ...
                return ItemAdapterC.this.move(fromPosition, toPosition);
            }
        }
        ...
        public ItemAdapterC<Item> remove(int position) {
            if (mOriginalItems != null) {
                ...
                return ItemAdapterC.this.remove(position);
            }
        }
        ...
        public ItemAdapterC<Item> removeRange(int position, int itemCount) {
            if (mOriginalItems != null) {
                ...
                return ItemAdapterC.this.removeRange(position, itemCount);
            }
        }
        ...
        public ItemAdapterC<Item> clear() {
            if (mOriginalItems != null) {
                ...
                return ItemAdapterC.this.clear();
            }
        }
    }
}
